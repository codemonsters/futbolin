...
public class Utiles {
	...
	public static Body crearCuerpo(World mundo, BodyType tipoCuerpo, float x, float y){
        ...
        bodyDef.position.set(x, y);  // En los cuerpos el origen de coordenadas es el centro
	...
	public static FixtureDef crearFixture(Shape formaCuerpo, float densidad, float friccion){ 
        FixtureDef fixtureDef = new FixtureDef();  // Creacion de la forma fisica en el cuerpo con datos como la forma, la densidad, la friccion (en este caso no está puesta)...
